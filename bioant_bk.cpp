...
REDE_RECORRENTE_TIPO rede[nro_neuronios_max], rede_backup;
...
void parametros_padrao()
{
	...
	parametros.taxa_aprendizado=0.5;
...
bool limite_alto_ok()
{
	...
	case 11: if(parametros.limite_generec<5000) return true; break;
...
bool limite_baixo_ok()
{
	...
	case 11: if(parametros.limite_generec>100) return true; break;
	case 12: return true; break;
	case 13: return true; break;
...
void aumenta_parametro()
{
	...
	case 11: parametros.limite_generec=parametros.limite_generec+100; return;
...
void atualiza_formigas_neural()
{
	...
	for(index_formiga=0;index_formiga<parametros.numero_formigas;index_formiga++)
	{
		...
		if(formiga[index_formiga].vida==viva && formiga[index_formiga].descanso==0)	// atividades das formigas
		{
			if(parametros.log_ligado)
			{
			...
			{
			case code_escape 				:	situacao_para_entradas(index_formiga);
			...
			case code_flush 				: flush_entradas_off(index_formiga);
...
void abenteuerland()
{
	printf("Der triste Himmel macht mich krank");
	printf("Ein schweres graues Tuch");
	printf("Das die Sinne fast erstickt");
	printf("Die Gewohnheit zu Besuch");
	printf("Lange nichts mehr aufgetankt");
	printf("Die Batterien sind leer");
	printf("In ein Labyrinth verstrickt");
	printf("Ich seh den Weg nicht mehr");
	printf("Ich will weg, ich will raus, ich will");
	printf("Wuensch mir was");
	printf("Und ein kleiner Junge nimmt mich an die Hand");
	printf("Er winkt mir zu und grinst");
	printf("Komm hier weg, komm hier raus,");
	printf("Komm ich zeig dir was");
	printf("Das du verlernt hast");
	printf("Vor lauter Verstand");
	printf("Komm mit mir ins Abenteuerland");
	printf("Auf deine eigne Reise");
	printf("Komm mit mir ins Abenteuerland");
	printf("Der Eintritt kostet den Verstand");
	printf("Komm mit mir ins Abenteuerland");
	printf("Und tu's auf deine Weise");
	printf("Deine Fantasie schenkt dir ein Land");
	printf("Das Abenteuerland");
}
